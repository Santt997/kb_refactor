...
echo -e "${BLUE}===============================================${NC}"
echo -e "${BLUE}      kb_refactor PyPI Release Assistant${NC}"
echo -e "${BLUE}===============================================${NC}"
...
case $option in
    1)
        ...
        echo -e "  ${YELLOW}pip install --index-url https://pypi.org --extra-index-url https://pypi.org kb_refactor${NC}"
        ;;
    2)
        ...
        echo -e "  ${YELLOW}pip install kb_refactor${NC}"
        ;;
    *)
